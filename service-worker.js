import { config } from "/package_bf9f78cd118f97e9a554acc18c2b69885d1f12b1/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_bf9f78cd118f97e9a554acc18c2b69885d1f12b1').then(async function (cache) {
